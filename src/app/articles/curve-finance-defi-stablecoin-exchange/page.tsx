...
const post = {
  ...
  content: (
    <>
      ...
      <p className="text-gray-700">
        Curve’s AMM model is particularly suited for stablecoins because it is
        optimized for assets that have minimal price differences. This is key in
        reducing slippage, ensuring that users get the best possible rate when
        swapping assets. Curve has become the go-to platform for traders and
        DeFi protocols that require efficient stablecoin trading, with billions
      ...
      <ul className="list-disc ml-6 text-gray-700">
        <li>
          Liquidity providers deposit stablecoins into Curve’s pools, earning
          interest from fees generated by the trades that occur in the pool.
        </li>
        <li>
      ...
      <p className="text-gray-700">
        Curve's model has been widely adopted by other DeFi platforms due to its
        efficiency in stablecoin trading. It has become a core component in
        yield farming strategies, with users leveraging Curve’s deep liquidity
      ...
      <div className="mt-8 bg-blue-100 p-4 rounded-lg">
        ...
        <p className="text-blue-700 mb-4">
          Discover how you can participate in Curve Finance’s liquidity pools
          and earn yields today.
        </p>
        <Link
          href="/project/curve"
